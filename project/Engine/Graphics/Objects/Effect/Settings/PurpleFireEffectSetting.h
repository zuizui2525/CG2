...
class PurpleFireEffectSetting : public EffectSetting {
public:
    PurpleFireEffectSetting() {
        name = "PurpleFire";
        textureName = "circle";
        isBillboard = true;
        isEmitter = true;
        ...
        colorStartMin = { 0.6f, 0.0f, 1.0f, 1.0f };
        colorStartMax = { 0.9f, 0.2f, 1.0f, 1.0f }; 
        colorEndMin = { 0.2f, 0.0f, 0.4f, 0.0f }; 
        colorEndMax = { 0.4f, 0.0f, 0.6f, 0.0f }; 
    }
};
